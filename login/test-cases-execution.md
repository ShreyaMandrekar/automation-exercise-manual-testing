...
**Actual Result:**
Incorrect email address with the correct password was rejected. The message `Your email or password is incorrect!` was displayed in red below the Password field.

**Status:** PASS

**Defect ID:** N/A

**Comments:** Application correctly prevents login with an incorrect email address.
...
**Actual Result:**
Incorrect email address with an incorrect password was rejected. The message `Your email or password is incorrect.` was displayed in red below the Password field, and the user was not logged in.

**Status:** PASS

**Defect ID:** N/A
 
**Comments:** Application correctly prevents login when both email address and password are incorrect.
