...
**Actual Result:**
The Name on Card and Card Number fields were filled, while CVC, Expiration Month, and Expiration Year were left blank. After clicking Pay and Confirm Order, the application displayed the browser validation message “Please fill out this field.” for the CVC field and prevented further submission.
...
**Comments:**
Mandatory-field validation was triggered correctly for the blank CVC field, and the payment form did not proceed until the required field was entered.
...
**Actual Result:**
The Name on Card, Card Number, and CVC fields were filled, while Expiration Month and Expiration Year were left blank. After clicking Pay and Confirm Order, the application displayed the browser validation message “Please fill out this field.” for the Expiration Month field and prevented further submission.
...
**Comments:**
Mandatory-field validation was triggered correctly for the blank Expiration Month field, and the payment form did not proceed until the required field was entered.
